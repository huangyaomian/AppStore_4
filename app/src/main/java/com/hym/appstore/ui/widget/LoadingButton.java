...
public class LoadingButton extends RelativeLayout {
    ...
    //region Variables
    static final int DEFAULT_COLOR = R.color.theme_blue;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                @SuppressLint("ResourceAsColor") int progressColor = a.getColor(R.styleable.LoadingButton_progressColor, DEFAULT_COLOR);
                setProgressColor(progressColor);

                @SuppressLint("ResourceAsColor") int textColor = a.getColor(R.styleable.LoadingButton_textColor, DEFAULT_COLOR);

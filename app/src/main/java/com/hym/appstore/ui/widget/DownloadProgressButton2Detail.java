...
public class DownloadProgressButton2Detail extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public DownloadProgressButton2Detail(Context context) {
        this(context, null);
    }

    public DownloadProgressButton2Detail(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DownloadProgressButton2Detail(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        DownloadProgressButton2Detail.SavedState ss = (DownloadProgressButton2Detail.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        return new DownloadProgressButton2Detail.SavedState(superState, (int) mProgress, mState, mCurrentText.toString());
    }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            ...
            @Override
            public DownloadProgressButton2Detail.SavedState createFromParcel(Parcel in) {
                return new DownloadProgressButton2Detail.SavedState(in);
            }

            @Override
            public DownloadProgressButton2Detail.SavedState[] newArray(int size) {
                return new DownloadProgressButton2Detail.SavedState[size];
            }
        };
    }

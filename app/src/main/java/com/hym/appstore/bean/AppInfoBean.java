...
public class AppInfoBean  implements Serializable {
    ...
    public void setRelateAppInfoList(List<AppInfoBean> relateAppInfoList) {
    ...
    public void setSameDevAppInfoList(List<AppInfoBean> sameDevAppInfoList) {
    ...
    public List<AppInfoBean> getRelateAppInfoList() {
    ...
    public List<AppInfoBean> getSameDevAppInfoList() {

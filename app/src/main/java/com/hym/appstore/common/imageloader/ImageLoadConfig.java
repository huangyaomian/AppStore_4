...
public class ImageLoadConfig {
    ...
    private ViewTarget<? extends View, Drawable> viewTarget;//指定viewTarget对象,可以是自定义View,该构造方法传入的view和通配符的view是同一个
    ...
    private ViewPropertyTransition.Animator animator; //在异步加载资源完成时会执行该动画。可以接受一个Animator对象
...
//        this.animator = builder.animator;
    ...
    public static class Builder {
        ...
        private ViewTarget<? extends View, Drawable> viewTarget;
